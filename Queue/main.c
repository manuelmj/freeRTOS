...
//estructura que define el tipo de dato enviado 
typedef enum{
    activity1,
    activity2,
    activity3
...
QueueHandle_t xQueue_string; //handle de la cola de datos string
...
//tareas para simular el envio y recepcion de los datos de tipo string (de longitud variable)
